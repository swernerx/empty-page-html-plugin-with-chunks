...
const ASSET_FILENAME = IS_PRODUCTION ? "file-[hash:base62:8].[ext]" : "[path][name].[ext]"
...
export default [
...

  {
    ...
    use: [
      // In an ideal world we would use the same CSS extraction in development.
      // Unfortunately the currently recommended CSS extraction approach does not (yet) support HMR.
      // See also: https://github.com/webpack-contrib/mini-css-extract-plugin
      IS_DEVELOPMENT ? "style-loader" : extractLoader,
      "cache-loader",
      "thread-loader",
      {
        loader: "css-loader",
